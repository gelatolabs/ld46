...
function menuDraw()
	...
	--	love.graphics.printf(buttons[i],0, 300 + 25*i, 800, "center")
		local button = gui:button("Start Button "..i, {x = (800 - 256) / 2, y = 300 + 50*i, w = 256, h = gui.style.unit * 2}) -- a button(label, pos, optional parent) gui.style.unit is a standard gui unit (default 16), used to keep the interface tidy
